        ...
        element.onmousedown = function(event) {
            ...
            element.onmouseup = function() {
                ...
                if (droppedOnField) {
                    ...
                    element.classList.remove('on-field'); // Stop being 'on-field' size/style
                    element.style.zIndex = 'auto'; // Reset z-index
    
                    // Removed the 'element.remove()' and Firebase delete calls from here
                    // The element will remain absolutely positioned on the body where it was dropped.
    
                     if (originalSpotId) {
                         // If it came from a spot, its data was removed from Firebase
                         // when it was appended to the body at the start of the drag.
                         // If you want it to return to its original spot's data state
                         // in Firebase on being dropped off-field, you would need to
                         // save its original data and put it back here.
